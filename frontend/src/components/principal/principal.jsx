...
export default function Navegacion() {
  ...
  const [isReportesOpen, setIsReportesOpen] = useState(false); // Por si lo usas más adelante
        ...
        <nav className="fixed top-0 z-50 w-full bg-[#000000]">
          <div className="px-3 py-3 lg:px-5 lg:pl-3">
            <div className="flex items-center justify-between">
              ...
              {/* Logo inline y Botón Hamburguesa Móvil */}
              <div className="flex items-center">
                
                {/* BOTÓN MÓVIL (Solución integrada) */}
                <button
                  onClick={() => setIsSidebarOpen(!isSidebarOpen)}
                  type="button"
                  className="inline-flex items-center p-2 text-sm text-gray-400 rounded-lg sm:hidden hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-600 me-3"
                >
...
// Fallback detection para navegadores sin backdrop-filter
